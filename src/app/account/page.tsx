...
import { User, Package, Repeat, ShieldCheck, CreditCard, ArrowRight } from 'lucide-react';
  ...
  if (!currentUser) {
    return (
      <div className="max-w-md mx-auto py-16 text-center space-y-4">
        ...
        <p className="text-xs text-slate-400">Log in to view your profile, orders, and trade quotes.</p>
        <Link
          href="/login"
    ...
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        >
          ...
          <p className="text-xs text-slate-400">View active shipments, tracking IDs, and past invoices.</p>
        </Link>
        ...
        >
          ...
          <p className="text-xs text-slate-400">Track pending sell/trade pickup requests and trade credit bonuses.</p>
        </Link>
      </div>
    </div>
  );
